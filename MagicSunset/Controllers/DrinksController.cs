...
namespace MagicSunset.Controllers
{
    public class DrinksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,drinkname,DrinkindId,Description,size,price")] Drinks drinks)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,drinkname,DrinkindId,Description,size,price")] Drinks drinks)
        {
            if (id != drinks.id)
            {
                return NotFound();
