...
namespace MagicSunset.Controllers
{
    public class DrinksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Drinkname,Description,Size,Price")] Drinks drinks)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Drinkname,Description,Size,Price")] Drinks drinks)
        {
            if (id != drinks.Id)
            {
                return NotFound();
